...
public class QueryTableDataResponse implements org.apache.thrift.TBase<QueryTableDataResponse, QueryTableDataResponse._Fields>, java.io.Serializable, Cloneable, Comparable<QueryTableDataResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("QueryTableDataResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new QueryTableDataResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new QueryTableDataResponseTupleSchemeFactory());
  }

  public List<com.siriusdb.thrift.model.VTable> tables; // optional
  ...
  public QueryTableDataResponse setTables(List<com.siriusdb.thrift.model.VTable> tables) {
    this.tables = tables;
    return this;
  }
  ...
  public QueryTableDataResponse setBaseResp(com.siriusdb.thrift.model.BaseResp baseResp) {
    this.baseResp = baseResp;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("QueryTableDataResponse(");
    boolean first = true;
  ...
  private static class QueryTableDataResponseStandardSchemeFactory implements SchemeFactory {
    public QueryTableDataResponseStandardScheme getScheme() {
      return new QueryTableDataResponseStandardScheme();
    }
  }

  private static class QueryTableDataResponseStandardScheme extends StandardScheme<QueryTableDataResponse> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tables = new ArrayList<com.siriusdb.thrift.model.VTable>(_list8.size);
                com.siriusdb.thrift.model.VTable _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new com.siriusdb.thrift.model.VTable();
                  _elem9.read(iprot);
      ...
      if (struct.tables != null) {
        if (struct.isSetTables()) {
          oprot.writeFieldBegin(TABLES_FIELD_DESC);
          {
            ...
            for (com.siriusdb.thrift.model.VTable _iter11 : struct.tables)
            {
              _iter11.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class QueryTableDataResponseTupleSchemeFactory implements SchemeFactory {
    public QueryTableDataResponseTupleScheme getScheme() {
      return new QueryTableDataResponseTupleScheme();
    }
  }

  private static class QueryTableDataResponseTupleScheme extends TupleScheme<QueryTableDataResponse> {
      ...
      if (struct.isSetTables()) {
        {
          ...
          for (com.siriusdb.thrift.model.VTable _iter12 : struct.tables)
          {
            _iter12.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.tables = new ArrayList<com.siriusdb.thrift.model.VTable>(_list13.size);
          com.siriusdb.thrift.model.VTable _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = new com.siriusdb.thrift.model.VTable();
            _elem14.read(iprot);
